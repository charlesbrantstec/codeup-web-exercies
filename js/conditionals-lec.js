...
if(itemCost > currentBalance){
    alert("The item's cost is too much");
}
// if(itemCost < currentBalance){
//     alert("You can afford the item");
// }
...
var numberOfLives = 5;
if (numberOfLives === 0)
    alert("Sorry, game over") else alert("Next level")
...
if (numberInput > 10) {
    ...
    alert("the number is lesss than 10");
}
...
var checkTrafficLight= function (color){
    if (color === 'green'){
        ...
        alert("Please etner a traffic light color: green, yellow, or red")
    }
}

checkTrafficLight(color: 'red')
...
// if they are 16 or older and have a permit, they are eligible for license, if they are 16 or older and do not have a permit, they are not eligble for a license.
var age = 10;
var havePermit = true;
...
if (age < 15) {
    ...
    if (age>= 16 && havePermit){
        alert("You are eligible fora license")
    }
...
message = (success) ? 'Operation was successful' : (name === chuck) ? 'hello, chuck' : 'Oops, something went wrong';
console.log(message);
...
// //WRITE YOUR TERNARY STATEMENT HERE!
//
// weatherMessage = (weather === 'rainy') ? 'It\'s raining T_T' : 'Have a nice day';
...
switch(weather) {
    case "sunny":
        console.log("It's sunny outside. Go for a walk")
        break;
    case "rainy":
        console.log("It's rainy outside. Grab an umbrella")
        break;
    case(weather===snowy):
        console.log("It's snowy outside. Stay inside and have some hot chocolate")
        break;
    default:
